	...
	var CourseXMLDocument = "../../XML/Course.xml";
	...
	var skipOverImagePath= "../../images/skipOver.jpg";
	var NextOverImagePath = "../../images/next_over.jpg"
	var NormalNextImagePath = "../../images/next_0.jpg"
	var lesson_mod_over = "../../images/mod_menu_over.jpg"
	var lesson_mod_norm = "../../images/mod_menu.jpg"
...
function GetRollOverPath(obj)
{
	...
	else if(obj.id == "Mod_Menu_Image1")
	{
		//alert("Mouse over"+obj.id+"path"+lesson_mod_over);
		img_src = lesson_mod_over;		
		obj.src=img_src;
	}
...
{	
	// 08 Jan
	if(window.opener.feedBack_ref!="")
	{
		window.opener.feedBack_ref.close();
	}
	window.opener.feedBack_ref="";
	/////////////////////
...
//alert("ReturnStringPath in write tags ="+ReturnStringPath);
	...
	{
		//alert(ReturnStringPath);	
		//alert("Before creating cookie - "+readCookie());
		setCookie(ReturnStringPath);		
	}
	...
	// For Loop1 Start
	{
		...
		for(var j=0; j<modules.childNodes[i].childNodes.length;j++)
		{
			...
			//alert('mCurrentModuleId :'+mCurrentModuleId);
							...
							if(Lessons.childNodes[k].childNodes[l].nodeName=="Pages")
							{
								...
								for(var m=0;m<Pages.childNodes.length;m++)
								{
									...
									{	//alert(Pages.childNodes[m].getAttribute("Name"));
										// if7
										//alert('mCurrentModuleId :'+mCurrentModuleId+'currentPage :'+currentPage);
										if(Pages.childNodes[m].getAttribute("Name")==currentPage)
										{
											...
											//alert("currentModule,currentLesson,currentPage"+currentModule+" "+currentLesson+" "+currentPage);
											//alert("nextLinkText "+nextLinkText );
											if(nextLinkText == "#")
											{
											   ...
											   nextLink = "<a id='anchorNext' tabindex='11' href=" + MenuURL  + " onfocus='focusOverNext()' onblur=focusOutNext() ><img alt='Next button' src='" + NormalNextImagePath + "' border=0 style='text-decoration:none' id='imgNext' onmouseover='GetRollOverPath(this)' onmouseout='GetRollOutPath(this)'/></a>";	
											...
											if(currentModule == "module11" && currentLesson=="lesson1" && currentPage=="m11l1010.html")
												{
														

													nextLink = "<a id='anchorNext' tabindex='11' alt='Next button' ><img src='" + DisableNextImagePath + "' border=0 style='text-decoration:none' id='imgNext' /></a>";

												   //nextLink = "<a id='anchorNext' tabindex='11' href='#' onfocus='focusOverNext()' onblur=focusOutNext() ><img alt='Next button' src='" + DisableNextImagePath + "' border=0 style='text-decoration:none' id='imgNext' /></a>";	
											   }
											   else
												{
											    nextLink = "<a id='anchorNext' tabindex='11'  href=" + nextLinkText + " onfocus='focusOverNext()' onblur=focusOutNext() ><img alt='Next button' src='" + NormalNextImagePath + "' border=0 style='text-decoration:none' id='imgNext' onmouseover='GetRollOverPath(this)' onmouseout='GetRollOutPath(this)'/></a>";
												}
											    mIsLastPage = false;
											}
	...
	var FooterHTMLStructure =  "<table width='100%' border='0' cellspacing='0' cellpadding='0'>" + 
      "<tr><td align='center' valign='middle'><div style='font-family: Verdana; font-style: normal; font-size: 14px; color: #A0A0A0;'>UNCLASSIFIED//FOUO</div></td></tr><tr>" +
        "<td width='95%' align='center' valign='middle'><table width='100%' border='0' cellpadding='0' cellspacing='0'>" +
          "<tr>" +
"<td width='1%' align='left'><table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td>";
	  
	if(currentModule == "module11")
	{
		FooterHTMLStructure +=  "<img border='0' alt='Lesson Menu' src='../../images/mod_menu.jpg' id='Mod_Menu_Image1'/></td><td><img src='../../images/prompt_lft.jpg'/></td></tr></table></td>";
	}
	else
	{
	 FooterHTMLStructure +=  "<a href='#' border='0' id='Mod_Menu_Image' onclick='openModMenu()'><img border='0' alt='Lesson Menu' src='../../images/mod_menu.jpg'id='Mod_Menu_Image1' onmouseover='GetRollOverPath(this)' onmouseout='GetRollOutPath(this)'/></td><td><img src='../../images/prompt_lft.jpg'/></td></tr></table></td>";
	}



            	 FooterHTMLStructure +=  "<td width='90%' align='center' valign='middle' background='../../images/prompt_bg.jpg'><table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>" +
              "<tr>" +
...
"          <tr>" +
"            <td width='9px'><img src='../../images/logo.jpg' alt='DHS logo' width='118' height='114' /></td>" +
"            <td width='320' background='../../images/logo_bg.jpg'><table width='100%' border='0' align='left' cellpadding='0' cellspacing='0'>" +
"              <tr>" +
"                <td><div><a href='#maincontent' tabindex='1' id='skipContent' onfocus='movefocus()' onblur='movefocusBack()'><img id='skipImage' alt='Skip Navigation' width='100' height='25'  src='../../images/skip_btn.jpg' onmouseover='moveover()' onmouseout='moveback()' onkeydown='page_Keydown(e,this)' width='1' height='1' border='0'></a></div></td>" +
"              </tr>" +
"              <tr>" +
...
"                      <tr>" +
"                        <td align='left' class='comment'>Add Comment</td>" +
"                        <td><img src='../../images/transparent.png' width='19'/></td>" +
"                        <td align='left' class='comment'>View Comments</td>" +
"                        </tr>" +
"                    </table>--></td>" +
"                    <td width='10%'>&nbsp;</td>" +
"                  </tr>" +
...
"                  <tr>" +
"                    <td width='80'>&nbsp;</td>" +
"                    <td align='left' tabindex='14' alt='Lesson name' valign='top' width='400px'><div id='Layer1' class='Textnormal'>" + GetModuleTitle + ": " + GetLessonTitle + "</div></td>" +
"                    </tr>" +
"                </table></td>" +
...
function fnMenuAction(obj)
{
    ...
    if(menuName == exitTagName)
	{
	   ...
	   if (confirm("Are you sure you want to exit the course ?"))
			{ 
					window.opener.IsCourseFirstTime = true;
					 window.close();
			} else {          
    ...
    if(menuName== resourceTagName)
    {
        ...
        window.open(mResourcePath,'Resource','width=505,height=538,left=505,top=134').focus();
    }
			        ...
			        for(var pgCtr=0; pgCtr<pages.childNodes.length;pgCtr++)
			        {
			            if(pages.childNodes[pgCtr].getAttribute("Name")== mCurrentPage)
			            {
                            ...
                            if(menuName== ccTagName)
                            {
								...
								if (getMediaValue()== "VIDEO")
                                    window.open(CCUrl,'CC','width=505,height=538,left=5,top=134,scrollbars = yes').focus();
								else if (getMediaValue()== "AUDIO")
                                    window.open(CCUrl,'CC','width=505,height=538,left=505,top=134,scrollbars = yes').focus();

                                else
                                    window.open('../../default_cc.html','CC','width=505,height=538,left=505,top=134').focus();
                            }
...
function getMediaValue()
{
    ...
    if(mediaYesNo== "Yes" )
        returnValue="VIDEO";       // CC On
    else if( flashCtlId != "")
		returnValue="AUDIO";       // CC On
	else
...
function page_Keydown(e,obj)
{
  ...
  keychar = String.fromCharCode(keynum);
	...
	// alert('you pressed alt and S::'+mSkipContentAnchorId)	
  ...
  else if(e.altKey && keychar=="L")
	{		
    document.getElementById('Mod_Menu_Image').focus();
	}
...
{
    return window.open(fileName,title,'width=1010,height=592,left=0,top=114,scrollbars = yes,location=yes');
}
...
{   
	...
	{ // LMS
		...
		{ 
			//imgPath = "images/mod_3_complete.jpg";       
			imgPath = "images/modu3_link_tick.jpg";
		}
		else
		{
		   imgPath = "images/modu3_link.jpg";
		}
	}
	else
	{ // Offline
...
{
	//width=505,height=538,left=505,top=134,scrollbars = yes'
          if (getMediaValue()== "VIDEO"){
			  window.open("../../"+mCurrentModule+"/mod_menu.html","Feedback2","toolbar=no,location=no,directories=no,status=no,scrollbars=yes,menubar=no,resizable=no,width=505,height=538,left=5,top=134");
			  
		  }else{
			   window.open("../../"+mCurrentModule+"/mod_menu.html","Feedback2","toolbar=no,location=no,directories=no,status=no,scrollbars=yes,menubar=no,resizable=no,width=505,height=538,left=505,top=134");
		  }
			   
}

function isModuleCompleted(modName)
{
    var modId= window.opener.ModuleCompleted ;
    var retVal= false;

		    if(modId == "module2" && modName=="module3")
		        retVal= true;
		    else if(modId == "module1" && modName=="module2")
		        retVal= true;
		    else if(modId == "module3" && modName=="module4")
		        retVal= true;
		    else if(modId == "module4" && modName=="module5")
		        retVal= true;
		    else if(modId == "module5" && modName=="module6")
		        retVal= true;
		    else if(modId == "module6" && modName=="module7")
		        retVal= true;
		    else if(modId == "module7" && modName=="module8")
		        retVal= true;		        
		    else if(modId == "module8" && modName=="module9")
		        retVal= true;		        
		    else if(modId == "module9" && modName=="module10")
		        retVal= true;
		    else if(modId == "module10" && modName=="module11")
		        retVal= true;		        
		    else if(modId == "module11" && modName=="module12")
		        retVal= true;		        
		    else if(modId == "module12" && modName=="module13")
		        retVal= true;		        
		        
            else if((modId == "" || modId ==null || modId== "undefined" || modId== undefined) && modName=="module1")
			{
...
function setMenuImage()
{
	...
	if(modId == "module13" )
	{
		document.getElementById("Image2").src="images/modu1_link_tick.jpg";
		document.getElementById("Image3").src="images/modu2_link_tick.jpg";
		document.getElementById("Image4").src="images/modu3_link_tick.jpg";
		document.getElementById("Image5").src="images/modu4_link_tick.jpg";
		document.getElementById("Image6").src="images/modu5_link_tick.jpg";
		document.getElementById("Image7").src="images/modu6_link_tick.jpg";
		document.getElementById("Image8").src="images/modu7_link_tick.jpg";
		document.getElementById("Image9").src="images/modu8_link_tick.jpg";
		document.getElementById("Image10").src="images/modu9_link_tick.jpg";
		document.getElementById("Image11").src="images/modu10_link_tick.jpg";
		document.getElementById("Image12").src="images/modu11_link_tick.jpg";
		document.getElementById("Image13").src="images/modu12_link_tick.jpg";
		document.getElementById("Image15").src="images/post_test_tick.jpg";
	}
